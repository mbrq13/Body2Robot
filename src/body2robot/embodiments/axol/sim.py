"""Viser-based Axol simulation for offline retargeting."""
...
try:
    ...
    raise ImportError(
        "viser is required for simulation. Install with: uv sync --extra axol"
    ) from e
...
class Sim:
    ...
    needed for visualising retargeted motion without hardware.
